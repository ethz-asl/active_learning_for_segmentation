...
with open(pathToAirsimMapping) as file:
    ...
    print("Going to overwrite semantic mapping of airsim using config stored at", pathToAirsimMapping)
    client.client.call('simGetSegmentationObjectID', ".*", 40) # Default assign otherpro to everything that is not matched
