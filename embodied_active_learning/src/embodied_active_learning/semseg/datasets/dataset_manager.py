...
from embodied_active_learning.utils.pytorch_utils import get_validation_transforms, get_train_transforms

class GenericFromFolderDataset(torch.utils.data.Dataset):
  """ Datloader to load images produced by the data acquisitors"""

  def __init__(self, folder_path, num_imgs=None, transform=None, image_ending = "image.png", mask_ending = "mask.png", weights_ending = "weights.npy"):
    super().__init__()
    self.entries = []
