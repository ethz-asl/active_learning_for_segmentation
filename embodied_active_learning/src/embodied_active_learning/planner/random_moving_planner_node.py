...
class RandomMovingPlanner:
    ...
    def sample_and_publish_next_trajectory(self, step=0.2):
        self.current_goal_yaw += 0.1*(random.random() * 2 * math.pi - math.pi)
...
if __name__ == '__main__':
    rospy.init_node('random_moving_planner', anonymous=True)
    planner = RandomMovingPlanner()
    rospy.spin()
